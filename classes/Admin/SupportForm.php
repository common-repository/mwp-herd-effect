...
class SupportForm {
	...
	public static function init(): void {
        ...
        <form method="post">
            ...
            <fieldset class="wpie-fieldset">
                <legend>
					<?php esc_html_e( 'Support Form', 'mwp-herd-effect' ); ?>
                </legend>

                <div class="wpie-fields is-column-2">
                    <div class="wpie-field">
                        <div class="wpie-field__title"><?php esc_html_e( 'Your Name', 'mwp-herd-effect' ); ?></div>
                    ...
                    <div class="wpie-field">
                        <div class="wpie-field__title"><?php esc_html_e( 'Contact email', 'mwp-herd-effect' ); ?></div>
                        <label class="wpie-field__label has-icon">
                ...
                <div class="wpie-fields is-column-2">
                    ...
                    <div class="wpie-field">
                        <div class="wpie-field__title"><?php esc_html_e( 'Link to the issue', 'mwp-herd-effect' ); ?></div>
                        <label class="wpie-field__label has-icon">
                    ...
                    <div class="wpie-field" data-field-box="menu_open">
                        <div class="wpie-field__title"><?php esc_html_e( 'Message type', 'mwp-herd-effect' ); ?></div>
                        <label class="wpie-field__label">
                            <select name="support[type]" id="support-type">
                                <option value="Issue"><?php esc_html_e( 'Issue', 'mwp-herd-effect' ); ?></option>
                                <option value="Idea"><?php esc_html_e( 'Idea', 'mwp-herd-effect' ); ?></option>
                            </select>
                        </label>
                    </div>
                ...
                <div class="wpie-fields is-column-2">
                    <div class="wpie-field">
                        <div class="wpie-field__title"><?php esc_html_e( 'Plugin', 'mwp-herd-effect' ); ?></div>
                        <label class="wpie-field__label has-icon">
                    ...
                    <div class="wpie-field">
                        <div class="wpie-field__title"><?php esc_html_e( 'License Key', 'mwp-herd-effect' ); ?></div>
                        <label class="wpie-field__label has-icon">
                            <span>🔑</span>
                ...
                <div class="wpie-fields is-column">
					<?php
					$content   = esc_attr__( 'Enter Your Message', 'mwp-herd-effect' );
                ...
                <div class="wpie-fields is-column">
                    ...
                    <div class="wpie-field">
						<?php submit_button( __( 'Send to Support', 'mwp-herd-effect' ), 'primary', 'submit', false ); ?>
                    </div>
                </div>
	...
	private static function send(): void {
		...
		if ( $send ) {
			$text = __( 'Your message has been sent to the support team.', 'mwp-herd-effect' );
			echo '<p class="notice notice-success">' . esc_html( $text ) . '</p>';
		} else {
			$text = __( 'Sorry, but message did not send. Please, contact us via support page.', 'mwp-herd-effect' );
	...
	private static function error(): ?string {
		...
		foreach ( $fields as $field ) {
			if ( empty( $_POST['support'][ $field ] ) ) {
				return __( 'Please fill in all the form fields below.', 'mwp-herd-effect' );
			}
		}
