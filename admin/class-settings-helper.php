...
class Settings_Helper {
	...
	public static function animationIn(): array {
		return [
			'bounceIn'          => __( 'bounceIn', 'mwp-herd-effect' ),
			'bounceInDown'      => __( 'bounceInDown', 'mwp-herd-effect' ),
			'bounceInLeft'      => __( 'bounceInLeft', 'mwp-herd-effect' ),
			'bounceInRight'     => __( 'bounceInRight', 'mwp-herd-effect' ),
			'bounceInUp'        => __( 'bounceInUp', 'mwp-herd-effect' ),
			'fadeIn'            => __( 'fadeIn', 'mwp-herd-effect' ),
			'fadeInDown'        => __( 'fadeInDown', 'mwp-herd-effect' ),
			'fadeInDownBig'     => __( 'fadeInDownBig', 'mwp-herd-effect' ),
			'fadeInLeft'        => __( 'fadeInLeft', 'mwp-herd-effect' ),
			'fadeInLeftBig'     => __( 'fadeInLeftBig', 'mwp-herd-effect' ),
			'fadeInRight'       => __( 'fadeInRight', 'mwp-herd-effect' ),
			'fadeInRightBig'    => __( 'fadeInRightBig', 'mwp-herd-effect' ),
			'fadeInUp'          => __( 'fadeInUp', 'mwp-herd-effect' ),
			'fadeInUpBig'       => __( 'fadeInUpBig', 'mwp-herd-effect' ),
			'flipInX'           => __( 'flipInX', 'mwp-herd-effect' ),
			'flipInY'           => __( 'flipInY', 'mwp-herd-effect' ),
			'lightSpeedIn'      => __( 'lightSpeedIn', 'mwp-herd-effect' ),
			'rotateIn'          => __( 'rotateIn', 'mwp-herd-effect' ),
			'rotateInDownLeft'  => __( 'rotateInDownLeft', 'mwp-herd-effect' ),
			'rotateInDownRight' => __( 'rotateInDownRight', 'mwp-herd-effect' ),
			'rotateInUpLeft'    => __( 'rotateInUpLeft', 'mwp-herd-effect' ),
			'rotateInUpRight'   => __( 'rotateInUpRight', 'mwp-herd-effect' ),
			'rollIn'            => __( 'rollIn', 'mwp-herd-effect' ),
			'zoomIn'            => __( 'zoomIn', 'mwp-herd-effect' ),
			'zoomInDown'        => __( 'zoomInDown', 'mwp-herd-effect' ),
			'zoomInLeft'        => __( 'zoomInLeft', 'mwp-herd-effect' ),
			'zoomInRight'       => __( 'zoomInRight', 'mwp-herd-effect' ),
			'zoomInUp'          => __( 'zoomInUp', 'mwp-herd-effect' ),
			'slideInDown'       => __( 'slideInDown', 'mwp-herd-effect' ),
			'slideInLeft'       => __( 'slideInLeft', 'mwp-herd-effect' ),
			'slideInRight'      => __( 'slideInRight', 'mwp-herd-effect' ),
			'slideInUp'         => __( 'slideInUp', 'mwp-herd-effect' ),
		];
	}

	public static function animationOut(): array {
		return [
			'bounceOut'          => __( 'bounceOut', 'mwp-herd-effect' ),
			'bounceOutDown'      => __( 'bounceOutDown', 'mwp-herd-effect' ),
			'bounceOutLeft'      => __( 'bounceOutLeft', 'mwp-herd-effect' ),
			'bounceOutRight'     => __( 'bounceOutRight', 'mwp-herd-effect' ),
			'bounceOutUp'        => __( 'bounceOutUp', 'mwp-herd-effect' ),
			'fadeOut'            => __( 'fadeOut', 'mwp-herd-effect' ),
			'fadeOutDown'        => __( 'fadeOutDown', 'mwp-herd-effect' ),
			'fadeOutDownBig'     => __( 'fadeOutDownBig', 'mwp-herd-effect' ),
			'fadeOutLeft'        => __( 'fadeOutLeft', 'mwp-herd-effect' ),
			'fadeOutLeftBig'     => __( 'fadeOutLeftBig', 'mwp-herd-effect' ),
			'fadeOutRight'       => __( 'fadeOutRight', 'mwp-herd-effect' ),
			'fadeOutRightBig'    => __( 'fadeOutRightBig', 'mwp-herd-effect' ),
			'fadeOutUp'          => __( 'fadeOutUp', 'mwp-herd-effect' ),
			'fadeOutUpBig'       => __( 'fadeOutUpBig', 'mwp-herd-effect' ),
			'flipOutX'           => __( 'flipOutX', 'mwp-herd-effect' ),
			'flipOutY'           => __( 'flipOutY', 'mwp-herd-effect' ),
			'lightSpeedOut'      => __( 'lightSpeedOut', 'mwp-herd-effect' ),
			'rotateOut'          => __( 'rotateOut', 'mwp-herd-effect' ),
			'rotateOutDownLeft'  => __( 'rotateOutDownLeft', 'mwp-herd-effect' ),
			'rotateOutDownRight' => __( 'rotateOutDownRight', 'mwp-herd-effect' ),
			'rotateOutUpLeft'    => __( 'rotateOutUpLeft', 'mwp-herd-effect' ),
			'rotateOutUpRight'   => __( 'rotateOutUpRight', 'mwp-herd-effect' ),
			'rollOut'            => __( 'rollOut', 'mwp-herd-effect' ),
			'zoomOut'            => __( 'zoomOut', 'mwp-herd-effect' ),
			'zoomOutDown'        => __( 'zoomOutDown', 'mwp-herd-effect' ),
			'zoomOutLeft'        => __( 'zoomOutLeft', 'mwp-herd-effect' ),
			'zoomOutRight'       => __( 'zoomOutRight', 'mwp-herd-effect' ),
			'zoomOutUp'          => __( 'zoomOutUp', 'mwp-herd-effect' ),
			'slideOutDown'       => __( 'slideOutDown', 'mwp-herd-effect' ),
			'slideOutLeft'       => __( 'slideOutLeft', 'mwp-herd-effect' ),
			'slideOutRight'      => __( 'slideOutRight', 'mwp-herd-effect' ),
			'slideOutUp'         => __( 'slideOutUp', 'mwp-herd-effect' ),
		];
	}
	...
	public static function modals( $id ): array {
		...
		$arr    = [];
		if ( empty( $result ) ) {
			$arr[] = __( 'Not created yet', 'mwp-herd-effect' );
		...
		foreach ( $result as $key => $value ) {
			$prev_id    = $value->id;
			$prev_title = ! empty( $value->title ) ? $value->title : __( 'UnTitle', 'mwp-herd-effect' );
			if ( absint( $prev_id ) === absint( $id ) && count( $result ) === 1 ) {
				$arr[] = __( 'Not created yet', 'mwp-herd-effect' );
				continue;
			}
			if ( absint($prev_id) === absint($id) ) {
				continue;
			}
			$arr[ 'wow-modal-id-' . $prev_id ] = $prev_title;
		}
